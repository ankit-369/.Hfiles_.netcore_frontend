...
const VaccinationList = () => {
    ...
    const vaccinationData = [
        ...
        },
        {
            id: 7,
            vaccine: 'PCV',
            dueAge: 'At 6 weeks, 14 weeks, 9 months',
            vaccinationDate: '22/5/2005',
            doctorName: 'Dr. Mehta',
            status: 'completed',
            checked: false
        },
                ...
                <>
                    ...
                    <div className="hidden md:block">
                        <div className="flex gap-2 mb-2">
                            {/* Table Headers */}
                            <div className="bg-cyan-300 px-4 py-3 text-center rounded-lg border border-gray-400 flex-1">
                                <span className="text-gray-800 font-semibold text-sm">Select</span>
                            </div>
                            <div className="bg-cyan-300 px-4 py-3 text-center rounded-lg border border-gray-400 flex-1">
                                <span className="text-gray-800 font-semibold text-sm">Vaccine</span>
                            </div>
                            <div className="bg-cyan-300 px-4 py-3 text-center rounded-lg border border-gray-400 flex-1">
                                <span className="text-gray-800 font-semibold text-sm">Due Age</span>
                            </div>
                            <div className="bg-cyan-300 px-4 py-3 text-center rounded-lg border border-gray-400 flex-1">
                                <span className="text-gray-800 font-semibold text-sm">Vaccination Date</span>
                            </div>
                            <div className="bg-cyan-300 px-4 py-3 text-center rounded-lg border border-gray-400 flex-1">
                                <span className="text-gray-800 font-semibold text-sm">Doctors Name</span>
                            </div>
                            <div className="bg-cyan-300 px-4 py-3 text-center rounded-lg border border-gray-400 flex-1">
                                <span className="text-gray-800 font-semibold text-sm">Action</span>
                            </div>
                        </div>

                        <div className="bg-white rounded-xl shadow-xl overflow-hidden border border-black">
