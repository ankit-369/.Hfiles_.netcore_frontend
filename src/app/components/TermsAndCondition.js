          ...
          <div className="content-container">
            <div className="inner_div">
              ...
              <div className="desciption">
                ...
                <p>
                  The platform located at <a href="http://hfiles.in/">http://hfiles.in/</a> is designated for personal use exclusively and should not be utilized for commercial purposes. Users are prohibited from engaging in activities such as decompiling reverse engineering renting leasing selling sublicensing copying modifying reproducing republishing distributing displaying or creating derivative works from the website. Additionally the use of network monitoring or discovery software to analyze the site's architecture or extract information regarding usage individual identities or users is strictly forbidden. Prior written consent is required from{' '}
                  <a href="http://hfiles.in/">http://hfiles.in/</a> to employ any robot spider automatic software or device or manual process for monitoring or duplicating content from the website. Unauthorized utilization of{' '}
                  <a href="http://hfiles.in/">http://hfiles.in/</a> is not allowed. The use of software tools (e.g. bots scraper tools) or other automatic devices to access monitor or duplicate website pages is prohibited unless explicitly authorized in writing by{' '}
                  <a href="http://hfiles.in/">http://hfiles.in/</a>. Users are not permitted to exploit the Site or any Content for unlawful purposes or activities that contravene the Terms of Use or to solicit engagement in illegal activities or actions that violate the rights of{' '}
                  <a href="http://hfiles.in/">http://hfiles.in/</a> or others.
                </p>

                <h2>Right to Modify or Terminate</h2>
                <p>
                  The website <a href="http://hfiles.in/">http://hfiles.in/</a> retains the authority to alter or cease the Service either temporarily or permanently at any given time with or without prior notification. The website{' '}
                ...
                <h2>Translations</h2>
                <p>
                  Translations available on the <a href="http://hfiles.in/">http://hfiles.in/</a> website are produced by third-party translators. While efforts have been made to ensure accuracy automated translations are not flawless and are not meant to replace human translation. These translations are offered as a convenience to users of the{' '}
                  <a href="http://hfiles.in/">http://hfiles.in/</a> website and are provided on an "as is" basis. It should be noted that certain content such as images videos and Flash files may not be translated accurately. The website{' '}
                  <a href="http://hfiles.in/">http://hfiles.in/</a> does not accept liability for any errors omissions or uncertainties in translations from English into other languages on the site. In case of any doubts regarding the accuracy of information in the translated version users are advised to consult the official English version of the website. Users are encouraged to contact the website administrators to report any translation errors or inaccuracies.
                </p>

                <h2>Miscellaneous</h2>
                <p>
                  The website <a href="http://hfiles.in/">http://hfiles.in/</a> retains the authority to alter amend supplement or delete sections of the Terms of Use without prior written notification at its own discretion. Any modifications to these Terms will be promptly implemented and communicated by updating the website with the revised Terms and specifying the 'last updated date. Users are advised to regularly review the Terms of Use for any changes. By continuing to use the website after such revisions are posted users are deemed to have accepted the updated Terms.
                </p>

                <h2>Jurisdiction</h2>
                <p>
                  These Terms will be regulated by and interpreted in accordance with Indian law. Any disagreement arising from these Terms will be subject to the exclusive jurisdiction of the courts situated in Mumbai Maharashtra.
                </p>
              </div>
            </div>
            <Footer/>
