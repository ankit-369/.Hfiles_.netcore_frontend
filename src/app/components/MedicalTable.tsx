...
const MedicalTable: React.FC<MedicalTableProps> = ({ habits, habitSelections, handleSelectionChange, setISocial, isSocial, handleSubmits }) => {
    return (
        <div className="w-full lg:w-2/3 xl:w-3/4 2xl:w-2/3 p-3 sm:p-4 lg:p-6">
            <h3 className="text-base sm:text-lg lg:text-xl font-semibold text-blue-800 text-center mt-4">
                Social History
            </h3>
            <p className="text-xs sm:text-sm mb-6 mt-4 sm:mb-4 text-center">
                ...
                <table className="w-full text-xs sm:text-sm border-collapse min-w-[300px]">
                    <thead>
                        <tr className="text-left border-b border-gray-300">
                            ...
                            <th className="py-2 px-4 text-start">Daily</th>
                            <th className="py-2 px-4 text-start">Occasionally</th>
                            <th className="py-2 px-4 text-start">Rarely</th>
                        </tr>
                    </thead>
            ...
            {isSocial && (
                <div className="flex justify-end mt-6">
                    <button
                        ...
                        className="px-6 py-2 primary hover:bg-blue-700 text-white text-sm font-semibold rounded-lg shadow"
                    >
                        Save
                    </button>
                </div>
